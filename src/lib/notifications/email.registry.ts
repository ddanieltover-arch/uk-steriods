...
export function getDemoOrderContext(): OrderNotificationContext {
  return {
    ...
    paymentInstructions: {
      ...
      note: 'Send crypto covering £33.94 to one of the wallet addresses below.',
      btcAddress: '1NZq2DekteiVLcbv8TndUfE6pHhEYtXEsf',
      ethAddress: '0x9ebC5BDb44dfC0c451637A9Dbc6eBD1B24CD9034',
      bchAddress: 'qrz4dutrw4tt6wlfgk6dza7spv6lg4gppc9szzgwc8',
    },
